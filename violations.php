                ...
                <tbody>
                    ...
                    if ($result && $result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            ...
                            // Added class 'driver-name' for filtering
                            echo "<tr>
                                    ...
                                    <td>
                                        ...
                                        <a href='violations.php?delete={$row['violation_id']}' onclick='return confirm(\"Delete this record?\")'>
                        ...
                        echo "<tr id='noData'><td colspan='5' align='center'>No violations recorded yet.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
...
<div id="violationModal" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="violations.php" method="POST" id="violationForm">
